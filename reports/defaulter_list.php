<?php
// Practical Assessment System - Subject-wise Defaulter List
// Zeal College of Engineering & Research

$page_title = "Defaulter List";
...
<div class="card mb-4">
  <div class="card-header" style="display: flex; justify-content: space-between; align-items: center;">
    <div>
      <h3 class="card-title"><i class="fas fa-exclamation-triangle text-danger me-2"></i> Subject-wise Defaulter List</h3>
        ...
        <?php else: ?>
          <?php foreach ($students as $st): ?>
            <?php 
              ...
              if (!$is_defaulter) continue; // Only show defaulter students
              $has_defaulters = true;
            ?>
            <tr style="background-color: rgba(239, 68, 68, 0.05);">
              ...
              <td><strong style="font-size: 1.05rem; color: #ef4444;"><?php echo $pct; ?>%</strong></td>
              <td>
                <span class="badge badge-danger">Defaulter (<75%)</span>
              </td>
            </tr>
          <?php endforeach; ?>
          <?php if (!isset($has_defaulters)): ?>
            <tr><td colspan="7" class="text-center" style="color: var(--text-muted); padding: 2rem;">No defaulter students found for this batch. All have >75% attendance!</td></tr>
          <?php endif; ?>
        <?php endif; ?>
      </tbody>
    </table>
